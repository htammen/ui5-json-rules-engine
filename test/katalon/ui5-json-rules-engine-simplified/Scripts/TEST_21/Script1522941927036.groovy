...
WebUI.setText(findTestObject('Test_16/Page_json-rules-engine-simplified/input___xmlview1--__input1-inn'), '21')
...
WebUI.verifyElementText(findTestObject('Test_16/Page_json-rules-engine-simplified/span_Cheers_US'), 'Cheers')
