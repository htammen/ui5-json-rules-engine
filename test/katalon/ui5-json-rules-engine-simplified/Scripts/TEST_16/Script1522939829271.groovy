...
WebUI.setText(findTestObject('Test_16/Page_json-rules-engine-simplified/input___xmlview1--__input1-inn'), '16')

WebUI.clickOffset(findTestObject('Test_16/Page_json-rules-engine-simplified/div_SWE'), 2, 2)

WebUI.verifyElementText(findTestObject('Test_16/Page_json-rules-engine-simplified/span_Unfortunately our governm'), 'Unfortunately our government has to decide to allow you to drink beer from 18 years on.')
